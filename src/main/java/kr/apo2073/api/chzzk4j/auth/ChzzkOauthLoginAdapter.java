...
import kr.apo2073.api.chzzk4j.auth.oauth.TokenRequestBody;
import kr.apo2073.api.chzzk4j.auth.oauth.TokenResponseBody;
import kr.apo2073.api.chzzk4j.util.HttpUtils;
...
public class ChzzkOauthLoginAdapter implements ChzzkLoginAdapter {
    ...
    public boolean equals(Object o) {
        ...
        return port == that.port
                && Objects.equals(redirectHost, that.redirectHost)
                && Objects.equals(succeedPage, that.succeedPage)
                && Objects.equals(failedPage, that.failedPage)
                && Objects.equals(state, that.state)
                && Objects.equals(code, that.code)
                && Objects.equals(accToken, that.accToken)
                && Objects.equals(refToken, that.refToken);
    }

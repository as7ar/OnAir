...
import kr.apo2073.api.chzzk4j.session.event.*;
...
import kr.apo2073.api.chzzk4j.session.message.system.ClientboundSystemConnected;
import kr.apo2073.api.chzzk4j.session.message.system.ClientboundSystemRevoked;
import kr.apo2073.api.chzzk4j.session.message.system.ClientboundSystemSubscribed;
import kr.apo2073.api.chzzk4j.session.message.system.ClientboundSystemUnsubscribed;
...
class ChzzkSession {
    ...
    private final List<ChzzkSessionSubscriptionType> subscriptions = new ArrayList<>();
    private final List<ChzzkSessionSubscriptionType> appliedSubscriptions = new ArrayList<>();
    ...
    private void checkRespond(Response response) {
        if (chzzk.isDebug) System.out.println(response);

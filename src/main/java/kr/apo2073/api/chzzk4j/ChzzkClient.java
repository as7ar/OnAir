package kr.apo2073.api.chzzk4j;

import com.google.gson.Gson;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import kr.apo2073.api.chzzk4j.auth.ChzzkLoginAdapter;
import kr.apo2073.api.chzzk4j.auth.ChzzkLoginResult;
import kr.apo2073.api.chzzk4j.auth.oauth.TokenRefreshRequestBody;
import kr.apo2073.api.chzzk4j.auth.oauth.TokenResponseBody;
import kr.apo2073.api.chzzk4j.exception.ChannelNotExistsException;
import kr.apo2073.api.chzzk4j.exception.NoAccessTokenOnlySupported;
import kr.apo2073.api.chzzk4j.exception.NotExistsException;
import kr.apo2073.api.chzzk4j.exception.NotLoggedInException;
import kr.apo2073.api.chzzk4j.types.ChzzkChatSettings;
import kr.apo2073.api.chzzk4j.types.ChzzkFollowingStatusResponse;
import kr.apo2073.api.chzzk4j.types.ChzzkRestrictedChannelResponse;
import kr.apo2073.api.chzzk4j.types.ChzzkUser;
import kr.apo2073.api.chzzk4j.types.channel.*;
import kr.apo2073.api.chzzk4j.types.channel.emoticon.ChzzkChannelEmotePackData;
import kr.apo2073.api.chzzk4j.types.channel.live.ChzzkLiveCategory;
import kr.apo2073.api.chzzk4j.types.channel.live.ChzzkLiveDetail;
import kr.apo2073.api.chzzk4j.types.channel.live.ChzzkLiveSettings;
import kr.apo2073.api.chzzk4j.types.channel.live.ChzzkLiveStatus;
import kr.apo2073.api.chzzk4j.types.channel.recommendation.ChzzkRecommendationChannels;
import kr.apo2073.api.chzzk4j.util.RawApiUtils;
...
public class ChzzkClient {
    ...
    private JsonObject fetchContentJson() {
    ...
    public @NotNull CompletableFuture<ChzzkChannelManager[]> fetchChannelManagers() throws NotLoggedInException, IllegalStateException {
        ...
        return CompletableFuture.supplyAsync(() -> {
            JsonObject contentJson = fetchContentJson();

            return gson.fromJson(contentJson, ChzzkChannelManager[].class);
        });
    }
            ...
            try {
                contentJson = RawApiUtils.getContentJson(
                        ...
                        RawApiUtils.httpGetRequest(
                                OPENAPI_URL + "/open/v1/channels/followers?page=" + page + "&size=" + size
                        ).build(),
                        isDebug).getAsJsonObject();
            } catch (IOException e) {
                throw new RuntimeException(e);

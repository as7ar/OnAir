...
public class ChzzkPartialChannel {
    ...
    public ChzzkChannelPersonalData personalData;
    public ChzzkChannelEmotePackData emotePackData;
    ...
    public boolean equals(Object o) {
        ...
        return verifiedMark == that.verifiedMark
                && Objects.equals(channelId, that.channelId)
                && Objects.equals(channelName, that.channelName)
                && Objects.equals(channelImageUrl, that.channelImageUrl)
                && Objects.equals(personalData, that.personalData)
                && Objects.equals(emotePackData, that.emotePackData);
    }

package kr.apo2073.api.chzzk4j.types.channel.live;
...
public class ChzzkLiveStatus {
    ...
    public boolean equals(Object o) {
        ...
        return concurrentUserCount == that.concurrentUserCount
                && accumulateCount == that.accumulateCount
                && paidPromotion == that.paidPromotion
                && adult == that.adult
                && clipActive == that.clipActive
                && chatActive == that.chatActive
                && minFollowerMinute == that.minFollowerMinute
                && chatDonationRankingExposure == that.chatDonationRankingExposure
                && Objects.equals(liveTitle, that.liveTitle)
                && Objects.equals(status, that.status)
                && Objects.equals(chatChannelId, that.chatChannelId)
                && Objects.equals(tags, that.tags)
                && Objects.equals(categoryType, that.categoryType)
                && Objects.equals(liveCategory, that.liveCategory)
                && Objects.equals(liveCategoryValue, that.liveCategoryValue)
                && Objects.equals(livePollingStatusJson, that.livePollingStatusJson)
                && Objects.equals(faultStatus, that.faultStatus)
                && Objects.equals(userAdultStatus, that.userAdultStatus)

...
import kr.astar.onair.api.toonLiv.Toonation
import kr.astar.onair.api.twitchLiv.Twitch
import kr.astar.onair.api.utubeLiv.Youtube
import kr.astar.onair.api.weflabLiv.Weflab
...
open class OnAir : JavaPlugin() {
    ...
    private fun printLogo() {
        ...
        val banner = bannerGenerator(
            ...
            author = description.authors.joinToString(", ")
        )

        banner.forEach { audiences.console().sendMessage(
...
//    private fun loadPlatformModule() {
//        val className = when {
//            BukkitPlatforms.isPaper() -> "kr.astar.onair.paper.OnAirPaper"
//            else -> "kr.astar.onair.spigot.OnAirSpigot"
//        }
//
//        println(className)
//        println(className)
...
//            val module = moduleClass.getConstructor().newInstance() as PlatformModule
//            module.platformEnable(this)
//        }.onFailure {
//            logger.warning("Failed to load platform module ($className): ${it.message}")
//        }
//    }

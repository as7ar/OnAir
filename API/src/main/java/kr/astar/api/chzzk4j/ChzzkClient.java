package kr.astar.api.chzzk4j;

import com.google.gson.Gson;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import kr.astar.api.chzzk4j.auth.ChzzkLoginAdapter;
import kr.astar.api.chzzk4j.auth.ChzzkLoginResult;
import kr.astar.api.chzzk4j.auth.oauth.TokenRefreshRequestBody;
import kr.astar.api.chzzk4j.auth.oauth.TokenResponseBody;
import kr.astar.api.chzzk4j.exception.ChannelNotExistsException;
import kr.astar.api.chzzk4j.exception.NoAccessTokenOnlySupported;
import kr.astar.api.chzzk4j.exception.NotExistsException;
import kr.astar.api.chzzk4j.exception.NotLoggedInException;
import kr.astar.api.chzzk4j.types.ChzzkChatSettings;
import kr.astar.api.chzzk4j.types.ChzzkFollowingStatusResponse;
import kr.astar.api.chzzk4j.types.ChzzkRestrictedChannelResponse;
import kr.astar.api.chzzk4j.types.ChzzkUser;
import kr.astar.api.chzzk4j.types.channel.*;
import kr.astar.api.chzzk4j.types.channel.emoticon.ChzzkChannelEmotePackData;
import kr.astar.api.chzzk4j.types.channel.live.ChzzkLiveCategory;
import kr.astar.api.chzzk4j.types.channel.live.ChzzkLiveDetail;
import kr.astar.api.chzzk4j.types.channel.live.ChzzkLiveSettings;
import kr.astar.api.chzzk4j.types.channel.live.ChzzkLiveStatus;
import kr.astar.api.chzzk4j.types.channel.recommendation.ChzzkRecommendationChannels;
import kr.astar.api.chzzk4j.util.RawApiUtils;
